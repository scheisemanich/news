...
if __name__ == "__main__":
    ...
    parser.add_argument("--json-file", default="/Users/brunowinter/Documents/ai/news/output/latest_news.json", help="Path to the JSON file with videos")
    parser.add_argument("--credentials", default="/Users/brunowinter/Documents/ai/news/config/client_secret.json", help="Path to the OAuth 2.0 client credentials file")
